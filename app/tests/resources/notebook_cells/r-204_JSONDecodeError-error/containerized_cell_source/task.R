...
expected_arg_names <- unique(c(expected_arg_names, "json_str"))
...
arg_type <- "None"
json_str <- parse_value(arg_value, arg_name, arg_type)
...
stopifnot(identical(deserialized_data, original_data))
