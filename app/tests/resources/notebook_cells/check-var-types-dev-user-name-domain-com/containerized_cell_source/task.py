...
arg_parser.add_argument('--id', action='store', type=str, required=True,
                        dest='id')

arg_parser.add_argument('--var_float', action='store', type=float,
                        required=True, dest='var_float')

arg_parser.add_argument('--var_int', action='store', type=int, required=True,
                        dest='var_int')

arg_parser.add_argument('--var_list_int', action='store', type=str,
                        required=True, dest='var_list_int')

arg_parser.add_argument('--var_list_str', action='store', type=str,
                        required=True, dest='var_list_str')

arg_parser.add_argument('--var_string', action='store', type=str,
                        required=True, dest='var_string')

arg_parser.add_argument('--var_string_with_comment', action='store', type=str,
                        required=True, dest='var_string_with_comment')

arg_parser.add_argument('--param_float', action='store', type=float,
                        required=True, dest='param_float')
arg_parser.add_argument('--param_int', action='store', type=int, required=True,
                        dest='param_int')
arg_parser.add_argument('--param_list_int', action='store', type=str,
                        required=True, dest='param_list_int')
arg_parser.add_argument('--param_list_str', action='store', type=str,
                        required=True, dest='param_list_str')
arg_parser.add_argument('--param_string', action='store', type=str,
                        required=True, dest='param_string')
arg_parser.add_argument('--param_string_with_comment', action='store',
                        type=str, required=True,
                        dest='param_string_with_comment')
...
try:
    ...
    if e.__class__.__name__ == 'JSONDecodeError':
        ...
        param_list_int = ast.literal_eval(
            args.param_list_int.replace('[', '["').replace(',', '","').replace(
                '" ', '"').replace(']', '"]').replace("'", ""))
    else:
        raise e
...
try:
    ...
    if e.__class__.__name__ == 'JSONDecodeError':
        ...
        param_list_str = ast.literal_eval(
            args.param_list_str.replace('[', '["').replace(',', '","').replace(
                '" ', '"').replace(']', '"]').replace("'", ""))
    else:
        raise e
